...
const feature_data: DataType[] = [
   {
      ...
      title: "Claim a Job",
      btn:"Find Home",
      desc: "Browse available gigs, starting with pharmacy lookup tasks.",
   },
   {
      id: 2,
      page: "home_1_feature_1",
      ...
      btn:"Rent Home",
      desc: "Contact pharmacies to check availability and record the results.",
   },
   {
      id: 3,
      page: "home_1_feature_1",
      ...
      btn:"Sell Property",
      desc: "Enter your findings and receive payment for your work.",
   },
...

   {
      ...
      icon: feature3Icon_1,
      title: "Flexible Work",
      desc: "Choose when and how often you want to work",
   },
   {
      id: 2,
      page: "home_1_feature_3",
      ...
      desc: "If you can follow instructions and make calls, you can start earning",
   },
   {
      id: 3,
      page: "home_1_feature_3",
      ...
      desc: "Get paid quickly for every completed job.",
   },
